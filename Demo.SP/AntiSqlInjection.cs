...
{
    /// <summary>
    /// http://www.bobylog.com/blog/2014/12/10/anti-sql-injection/
    /// </summary>
    public class AntiSqlInjection
    {
        ...
        public static IEnumerable<string> ValidateIntegerList(IEnumerable<string> oidList,
        ...
        public static string ValidateSqlValue(string value)
        {
            ...
            if (RegexValue.IsMatch(value.Replace("''", string.Empty)))
                return value;
            throw new ApplicationException(string.Format("ValidateSqlValue: SQL value is not legitimate. Field: {0}",
                value));
        }
